...
def add_model_config_args(parser):
    ...
    group.add_argument('--load-model', action='store_true',
                       help='load model from checkpoints')
    group.add_argument('--strict', action='store_true',
                       help='load model from checkpoints in strict')
    group.add_argument('--fix-model-state', action='store_true',
                       help='add prefix before model state dict item')
...
def add_training_args(parser):
    ...
    group.add_argument('--valid-interval', type=int, default=10000,
                       help='valid interval')
    group.add_argument('--train-iters', type=int, default=1000000,
                       help='number of iterations per epoch')
    group.add_argument('--seed', type=int, default=1234,
                       help='random seed')
    group.add_argument('--use-token-type', action='store_true',
                       help='use token type in input')
    group.add_argument('--use-task-embedding', action='store_true',
                       help='use task embedding in input')
    group.add_argument('--use-cls-special', action='store_true',
                       help='use different cls token')
    group.add_argument('--fine-tune', action='store_true',
                       help='fine tune model')
    group.add_argument('--qa-style-data', action='store_true',
                       help='fine tune model')
    group.add_argument('--only-gpt', action='store_true',
                       help='only train gpt model')
    group.add_argument('--multi-doc', action='store_true',
                       help='task embedding train')
    group.add_argument('--no-nsp', action='store_true',
                       help='bert with gpt no nsp')
    group.add_argument('--drop-first-token', action='store_true',
                       help='drop frist token')
    group.add_argument('--use-task-embed', action='store_true',
                       help='use task embedding')
    # Learning rate.
...
def add_data_args(parser):
    ...
    group.add_argument('--train-data', nargs='+',
                       help='Filename (or whitespace separated filenames) '
                       'for training.')
    group.add_argument('--train-prefix', type=str, default="corpus",
                       help='prefix of train data')
    group.add_argument('--max-lens', type=int, default=512,
                       help='max lens of train data')
    group.add_argument('--max-tokens', type=int, default=5000,
                       help='max tokens of per batch')
    group.add_argument('--train-batch', type=int, default=64,
                       help='batch of train data')
    group.add_argument('--valid-batch', type=int, default=64,
                       help='batch of valid data')
    ...
    group.add_argument('--valid-prefix', type=str, default="corpus-MLM,corpus-CLM",
                       help='prefix of train data')
    ...
    group.add_argument('--mask-lm-prob', type=float, default=0.15)
